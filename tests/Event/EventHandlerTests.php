...
class EventHandlerTests extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new EventHandlerTestable();
    }
    ...
    public function test_eventHandler_sendCommand()
    {
    ...
    public function test_eventHandler_shouldQueue_true()
    {
    ...
    public function test_eventHandler_shouldQueue_false()
    {
        $event = new EventExample();
